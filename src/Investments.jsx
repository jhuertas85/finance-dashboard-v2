...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', status: 'TRIM', addLevels: [{ price: 420, amount: '$800' }, { price: 375, amount: '$1,000' }], trimLevels: [{ price: 480, action: 'take profit — G3 (+245%): sell 6 sh now' }, { price: 620, action: 'sell 4 sh' }], notes: 'G3 triggered: +245% gain → sell 6sh ~$476 now · consensus $613 · AI-compute factor 52% (G5) · keep core for $620', invalidation: 'below $350 = AI semis cycle breaking → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
    { id: 'nvda', ticker: 'NVDA', name: 'NVIDIA', platform: 'WIO', type: 'STK', shares: 29.79087899, price: 208.65, costPerShare: 181.18, currency: 'USD', status: 'ACCUMULATE', addLevels: [{ price: 200, amount: '$1,500' }, { price: 185, amount: '$1,500' }], trimLevels: [{ price: 295, action: 'trim 6 sh' }, { price: 340, action: 'trim 6 sh' }], notes: 'At $222 · consensus $303 · 37% upside · 61 analysts Strong Buy · earnings Aug 26 key catalyst', invalidation: 'below $170 = AI capex doubts / Blackwell miss → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
    { id: 'avgo', ticker: 'AVGO', name: 'Broadcom', platform: 'WIO', type: 'STK', shares: 5.79772382, price: 392.13, costPerShare: 395.40, currency: 'USD', status: 'ACCUMULATE', addLevels: [{ price: 345, amount: '$1,200' }, { price: 310, amount: '$1,200' }], trimLevels: [{ price: 530, action: 'trim 2 sh' }], notes: 'At $380 below cost $395 · consensus $528 · +39% upside · Google/Anthropic/OpenAI XPU · FY26 EPS +50%', invalidation: 'below $285 = custom silicon wins drying up → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
    { id: 'meta', ticker: 'META', name: 'Meta Platforms', platform: 'WIO', type: 'STK', shares: 4.93349486, price: 563.85, costPerShare: 593.78, currency: 'USD', status: 'ACCUMULATE', addLevels: [{ price: 540, amount: '$500' }, { price: 500, amount: '$500' }], trimLevels: [{ price: 750, action: 'trim 1.5 sh' }, { price: 900, action: 'trim 2 sh' }], notes: 'EPS miss one-time charges · rev +28% intact · at $579 near cost · consensus $754 · 30% upside', invalidation: 'below $430 = ad revenue structural decline → EXIT', theme: 'mega-cap-growth', bucket: 'discretionary' },
    ...
    { id: 'wio-growth', ticker: 'WIO-G', name: 'WIO Growth Accelerator', platform: 'WIO', type: 'WLT', shares: 1, price: 1950.91, costPerShare: 2000, currency: 'USD', status: 'HOLD', addLevels: [], trimLevels: [], notes: 'Managed · growth accelerator', invalidation: 'n/a — managed product', theme: 'other', bucket: 'discretionary' },
    // DH / Talabat
    { id: 'dher', ticker: 'DHER', name: 'Delivery Hero SE', platform: 'DH/Talabat', type: 'STK', shares: 998, price: 36.89, costPerShare: 0, currency: 'EUR', addLevels: [], trimLevels: [{ price: 41.5, action: 'tender all shares — Uber deal price' }], status: 'WATCH', isGrant: true, notes: 'Uber deal €41.50 · spread 12.2% (€37→41.5) · EU/ME regulatory review · tender when window opens · pure profit', invalidation: 'deal collapses or <€32 sustained → reassess', theme: 'other', bucket: 'company' },
    { id: 'talabat', ticker: 'TALABAT', name: 'Talabat Holding', platform: 'DH/Talabat', type: 'STK', shares: 6250, price: 0.96, costPerShare: 1.60, currency: 'AED', addLevels: [], trimLevels: [], status: 'WATCH', isEmployerStock: true, notes: 'Employer stock · AED 1.17 now (stored 0.96 +22% ⚠) · analyst target 1.35 · hold to cost 1.60 · DHER deal tailwind', invalidation: 'Uber deal impairs or <AED 0.80 → reassess', theme: 'other', bucket: 'company' },
    // Binance
    { id: 'shib', ticker: 'SHIB', name: 'Shiba Inu', platform: 'Binance', type: 'CRY', shares: 33631778.8241496213, price: 0.00000458, costPerShare: 0.0000072, currency: 'USD', status: 'WATCH', addLevels: [], trimLevels: [], notes: 'Meme · -36% vs cost · 94% below ATH · Shibarium upgrade delayed · no catalysts · hold or exit', invalidation: 'below $0.000003 = meme cycle over → EXIT', theme: 'crypto', bucket: 'discretionary' },
    { id: 'eth', ticker: 'ETH', name: 'Ethereum', platform: 'Binance', type: 'CRY', shares: 1.031663937, price: 1658.07, costPerShare: 3586.88, currency: 'USD', status: 'WATCH', addLevels: [], trimLevels: [{ price: 4000, action: 'break-even exit' }], notes: 'G2 triggered: -48% vs cost · range $1,680-2,090 · ETF inflows steady · break-even $3,587 is 94% away', invalidation: 'below $1,200 = structural loss of demand → EXIT', theme: 'crypto', bucket: 'discretionary' },
    { id: 'sol-binance', ticker: 'SOL', name: 'Solana (Binance)', platform: 'Binance', type: 'CRY', shares: 40.1310624738, price: 69.13, costPerShare: 159.46, currency: 'USD', status: 'WATCH', addLevels: [], trimLevels: [{ price: 140, action: 'partial exit' }], notes: 'G2 triggered: -54% vs cost · 159M daily txns · no adds until thesis re-underwritten above $77', invalidation: 'below $40 = ecosystem collapse → EXIT', theme: 'crypto', bucket: 'discretionary' },
  ],
  closedPositions: [
  ...
  config: {
    dryCash: 5500,
    addPriority: 'NVDA → AVGO → META → AMZN → NOW',
    lastUpdated: null,
    analysisDate: '2026-08-20T09:00:00.000Z',
    portfolio: {
      concentration: { AMD: 28.7, NVDA: 15.7, 'WIO-Managed': 10.6, CSPX: 9.9, 'SOL(both)': 9.5, META: 6.8, AMZN: 6.2, AVGO: 5.2, ETH: 4.5, NOW: 2.5, SHIB: 0.4 },
      factorMap: { 'AI-compute': 52.1, 'mega-cap-growth': 12.9, crypto: 14.4, 'index-base': 9.9, other: 10.6 },
      cryptoPct: 14.4,
      cashPct: 11.6,
      flags: [
        'AI-compute 52.1% > 50% cap — Guardrail 5 breach: no new adds without flagging',
        'Crypto 14.4% > 10% cap — Guardrail 2: clear addLevels on SOL/ETH/SHIB (done)',
        'AMD +245% gain — Guardrail 3: mandatory trim (sell 6 sh ~$476 now)',
        'AMD 28.7% — approaching 30% concentration ceiling (Guardrail 4); trim resolves this'
      ],
      benchmarkVsCSPX: 'Active book -3.8% vs CSPX +4.8% since 31 Jul 2026 (-8.6pp lag, AMD/crypto drag)',
    },
  },
};
