...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', addLevels: [{ price: 440, amount: '$1,000' }, { price: 400, amount: '$1,500' }], trimLevels: [{ price: 575, action: 'sell 3 sh' }, { price: 640, action: 'sell 3 sh' }], status: 'HOLD', notes: 'Core winner · 3.6× from cost · Zen 6 Venice launch Jul 22 · trim above $575' },
    { id: 'nvda', ticker: 'NVDA', name: 'NVIDIA', platform: 'WIO', type: 'STK', shares: 29.79087899, price: 208.65, costPerShare: 181.18, currency: 'USD', addLevels: [{ price: 185, amount: '$1,500' }, { price: 165, amount: '$1,500' }], trimLevels: [{ price: 285, action: 'trim 6 sh' }, { price: 330, action: 'trim 6 sh' }], status: 'ACCUMULATE', notes: 'Dominant AI infra · Blackwell ramp · 44-49% to consensus $305 · add on any weakness' },
    { id: 'avgo', ticker: 'AVGO', name: 'Broadcom', platform: 'WIO', type: 'STK', shares: 5.79772382, price: 392.13, costPerShare: 395.40, currency: 'USD', addLevels: [{ price: 350, amount: '$1,200' }, { price: 320, amount: '$1,200' }], trimLevels: [{ price: 490, action: 'trim 2 sh' }], status: 'ACCUMULATE', notes: 'At cost · custom AI XPUs for hyperscalers · 30% to consensus $515 · add on dips' },
    { id: 'meta', ticker: 'META', name: 'Meta Platforms', platform: 'WIO', type: 'STK', shares: 4.93349486, price: 563.85, costPerShare: 593.78, currency: 'USD', addLevels: [{ price: 600, amount: '$1,000' }, { price: 560, amount: '$1,000' }], trimLevels: [{ price: 800, action: 'trim 1.5 sh' }], status: 'HOLD', notes: 'Real price ~$664 · Meta Compute + Iris chip Sep · 24% to consensus $826 · wait for pullback to add' },
    { id: 'amzn', ticker: 'AMZN', name: 'Amazon', platform: 'WIO', type: 'STK', shares: 9.89225353, price: 232.79, costPerShare: 208.12, currency: 'USD', addLevels: [{ price: 215, amount: '$800' }], trimLevels: [{ price: 290, action: 'trim 3 sh' }], status: 'HOLD', notes: 'AWS + AI infra leader · 28% to consensus $315 · trim starts $290' },
    { id: 'now', ticker: 'NOW', name: 'ServiceNow', platform: 'WIO', type: 'STK', shares: 9.8993178, price: 93.01, costPerShare: 102.81, currency: 'USD', addLevels: [{ price: 95, amount: '$500' }], trimLevels: [{ price: 140, action: 'trim 3 sh' }], status: 'ACCUMULATE', notes: 'Near cost · earnings Jul 22 · 35% to consensus $143 · enterprise AI workflows' },
    { id: 'cake', ticker: 'CAKE', name: 'Cheesecake Factory', platform: 'WIO', type: 'STK', shares: 11, price: 76.91, costPerShare: 48.50, currency: 'USD', addLevels: [{ price: 63, amount: '$800' }], trimLevels: [{ price: 90, action: 'sell 5 sh' }], status: 'HOLD', notes: 'Add only on pullback to analyst consensus · trim at $90 (Citi target)' },
    ...
    { id: 'sol-wio', ticker: 'SOL', name: 'Solana (WIO)', platform: 'WIO', type: 'CRY', shares: 14.07539626, price: 69.10, costPerShare: 161.14, currency: 'USD', addLevels: [{ price: 50, amount: 'DCA' }, { price: 40, amount: 'DCA' }], trimLevels: [{ price: 140, action: 'partial exit' }], status: 'WATCH', notes: 'Key level $77 · flip to support → $125-130 · SC target $250 year-end · DCA only at levels' },
    ...
    // DH / Talabat
    { id: 'dher', ticker: 'DHER', name: 'Delivery Hero SE', platform: 'DH/Talabat', type: 'STK', shares: 998, price: 36.89, costPerShare: 0, currency: 'EUR', addLevels: [], trimLevels: [{ price: 41.5, action: 'Uber deal price — full exit' }], status: 'HOLD', isGrant: true, notes: 'Uber acquisition bid €41.50 · hold to deal close · 998 grant shares = pure profit · spread +8.7%' },
    ...
    { id: 'eth', ticker: 'ETH', name: 'Ethereum', platform: 'Binance', type: 'CRY', shares: 1.031663937, price: 1658.07, costPerShare: 3586.88, currency: 'USD', addLevels: [], trimLevels: [{ price: 4000, action: 'break-even exit' }], status: 'WATCH', notes: 'Break-even exit $4,000 · critical support $1,500 · if broken → $1,000-1,300 possible · no adds' },
