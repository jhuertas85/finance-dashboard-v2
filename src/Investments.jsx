...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', addLevels: [{ price: 440, amount: '$1,000' }, { price: 400, amount: '$1,500' }], trimLevels: [{ price: 600, action: 'sell 3 sh' }, { price: 640, action: 'sell 3 sh' }], status: 'ACCUMULATE', notes: 'Down 17% from peak to ~$460 · Core Sci $14B data center deal · earnings Aug 4 · 12% options swing · consensus $575 · add at $440/$400' },
    { id: 'nvda', ticker: 'NVDA', name: 'NVIDIA', platform: 'WIO', type: 'STK', shares: 29.79087899, price: 208.65, costPerShare: 181.18, currency: 'USD', addLevels: [{ price: 185, amount: '$1,500' }, { price: 165, amount: '$1,500' }], trimLevels: [{ price: 285, action: 'trim 6 sh' }, { price: 330, action: 'trim 6 sh' }], status: 'ACCUMULATE', notes: 'At ~$192 · consensus $303 · 57% upside · 55 analysts Strong Buy · Rubin+Blackwell demand intact · earnings Aug 25' },
    { id: 'avgo', ticker: 'AVGO', name: 'Broadcom', platform: 'WIO', type: 'STK', shares: 5.79772382, price: 392.13, costPerShare: 395.40, currency: 'USD', addLevels: [{ price: 350, amount: '$1,200' }, { price: 315, amount: '$1,200' }], trimLevels: [{ price: 500, action: 'trim 2 sh' }], status: 'ACCUMULATE', notes: 'At $385 below cost $395 · AI XPU FY28 bookings · consensus $525 · 36% upside · Morgan Stanley core AI winner · add at $350/$315' },
    ...
    // DH / Talabat
    { id: 'dher', ticker: 'DHER', name: 'Delivery Hero SE', platform: 'DH/Talabat', type: 'STK', shares: 998, price: 36.89, costPerShare: 0, currency: 'EUR', addLevels: [], trimLevels: [{ price: 41.5, action: 'Uber deal price — tender all shares' }], status: 'HOLD', isGrant: true, notes: 'Uber €41.50 deal · stock €37.49 · spread 10.7% · regulatory + >50% accept pending · tender when process opens · 998 grant = pure profit' },
    ...
    // Binance
    { id: 'shib', ticker: 'SHIB', name: 'Shiba Inu', platform: 'Binance', type: 'CRY', shares: 33631778.8241496213, price: 0.00000458, costPerShare: 0.0000072, currency: 'USD', addLevels: [], trimLevels: [], status: 'WATCH', notes: 'Meme · ~$0.0000046 · 200MA declining · no catalysts · hold or cut loss · no adds' },
    { id: 'eth', ticker: 'ETH', name: 'Ethereum', platform: 'Binance', type: 'CRY', shares: 1.031663937, price: 1658.07, costPerShare: 3586.88, currency: 'USD', addLevels: [], trimLevels: [{ price: 4000, action: 'break-even exit' }], status: 'WATCH', notes: 'At $1,900 · approaching $2,050 monthly close key level · bull case $4,000 · cost $3,587 still 88% away · hold' },
  ...
  config: { dryCash: 5500, addPriority: 'NVDA → AMD → META → AVGO → AMZN → NOW', lastUpdated: null, analysisDate: '2026-07-31T00:00:00.000Z' },
};
