...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', addLevels: [{ price: 440, amount: '$1,000' }, { price: 400, amount: '$1,500' }], trimLevels: [{ price: 600, action: 'sell 3 sh' }, { price: 640, action: 'sell 3 sh' }], status: 'HOLD', notes: 'Up 290%+ from cost · Q2 earnings Aug 4 · Goldman $640 · consensus $571 · Zen 6 live · trim starts $600' },
    { id: 'nvda', ticker: 'NVDA', name: 'NVIDIA', platform: 'WIO', type: 'STK', shares: 29.79087899, price: 208.65, costPerShare: 181.18, currency: 'USD', addLevels: [{ price: 185, amount: '$1,500' }, { price: 165, amount: '$1,500' }], trimLevels: [{ price: 285, action: 'trim 6 sh' }, { price: 330, action: 'trim 6 sh' }], status: 'ACCUMULATE', notes: 'AI infra dominant · $500B+ Blackwell/Rubin revenue visibility · consensus $303 · ~$207 now · 46% upside · add dips' },
    { id: 'avgo', ticker: 'AVGO', name: 'Broadcom', platform: 'WIO', type: 'STK', shares: 5.79772382, price: 392.13, costPerShare: 395.40, currency: 'USD', addLevels: [{ price: 350, amount: '$1,200' }, { price: 315, amount: '$1,200' }], trimLevels: [{ price: 500, action: 'trim 2 sh' }], status: 'ACCUMULATE', notes: 'Below cost · AI XPU bookings FY28 visibility · consensus $525 · 38% upside · Morgan Stanley "core AI winner" · add dips' },
    { id: 'meta', ticker: 'META', name: 'Meta Platforms', platform: 'WIO', type: 'STK', shares: 4.93349486, price: 563.85, costPerShare: 593.78, currency: 'USD', addLevels: [{ price: 560, amount: '$1,000' }, { price: 530, amount: '$1,000' }], trimLevels: [{ price: 800, action: 'trim 1.5 sh' }], status: 'ACCUMULATE', notes: 'Earnings Jul 29 · $60B Q2 rev expected · 40% to consensus $826 · below cost · capex $125-145B risk · buy on dip' },
    { id: 'amzn', ticker: 'AMZN', name: 'Amazon', platform: 'WIO', type: 'STK', shares: 9.89225353, price: 232.79, costPerShare: 208.12, currency: 'USD', addLevels: [{ price: 225, amount: '$800' }], trimLevels: [{ price: 290, action: 'trim 3 sh' }], status: 'HOLD', notes: 'Earnings Jul 30 · AWS Q2 est 33% growth · consensus $315-335 · ~$247 now (+6%) · trim starts $290' },
    { id: 'now', ticker: 'NOW', name: 'ServiceNow', platform: 'WIO', type: 'STK', shares: 9.8993178, price: 93.01, costPerShare: 102.81, currency: 'USD', addLevels: [{ price: 95, amount: '$800' }, { price: 85, amount: '$1,000' }], trimLevels: [{ price: 140, action: 'trim 3 sh' }], status: 'ACCUMULATE', notes: 'Q2 beat: $3.99B rev, AI ACV +50% to $1.5B · below cost · 43% to JP Morgan $145 · enterprise AI workflows' },
    { id: 'cake', ticker: 'CAKE', name: 'Cheesecake Factory', platform: 'WIO', type: 'STK', shares: 11, price: 76.91, costPerShare: 48.50, currency: 'USD', addLevels: [{ price: 63, amount: '$800' }], trimLevels: [{ price: 78, action: 'trim 3 sh' }, { price: 90, action: 'sell 5 sh' }], status: 'TRIM', notes: 'Earnings Jul 28 · $77 above avg analyst target $62 · overextended · trim now · only re-add if crashes to $63' },
    { id: 'cspx', ticker: 'CSPX', name: 'iShares S&P 500 UCITS', platform: 'WIO', type: 'ETF', shares: 4.99747, price: 795.24, costPerShare: 809.73, currency: 'USD', addLevels: [], trimLevels: [], status: 'ACCUMULATE', notes: 'The base · ~$802 near 52-week high $818 · S&P strong · keep accumulating on −5% dips · never trim' },
    { id: 'sol-wio', ticker: 'SOL', name: 'Solana (WIO)', platform: 'WIO', type: 'CRY', shares: 14.07539626, price: 69.10, costPerShare: 161.14, currency: 'USD', addLevels: [{ price: 50, amount: 'DCA' }, { price: 40, amount: 'DCA' }], trimLevels: [{ price: 140, action: 'partial exit' }], status: 'WATCH', notes: 'Testing $77 resistance now ($76) · on-chain near ATH · flip $77 → $90-125 · cost $161 · DCA only at $50/$40' },
    ...
    // DH / Talabat
    { id: 'dher', ticker: 'DHER', name: 'Delivery Hero SE', platform: 'DH/Talabat', type: 'STK', shares: 998, price: 36.89, costPerShare: 0, currency: 'EUR', addLevels: [], trimLevels: [{ price: 41.5, action: 'Uber deal price — full exit' }], status: 'HOLD', isGrant: true, notes: 'Uber $14.8B deal €41.50 CONFIRMED Jul 16 · pending regulatory + >50% accept · 998 grant shares = pure profit · spread ~12%' },
    { id: 'talabat', ticker: 'TALABAT', name: 'Talabat Holding', platform: 'DH/Talabat', type: 'STK', shares: 6250, price: 0.96, costPerShare: 1.60, currency: 'AED', addLevels: [], trimLevels: [], status: 'WATCH', isEmployerStock: true, notes: 'Employer stock · AED 1.19 now (+24%) · target 1.33-1.88 · Uber/DHER deal positive spillover · hold, working there' },
    // Binance
    { id: 'shib', ticker: 'SHIB', name: 'Shiba Inu', platform: 'Binance', type: 'CRY', shares: 33631778.8241496213, price: 0.00000458, costPerShare: 0.0000072, currency: 'USD', addLevels: [], trimLevels: [], status: 'WATCH', notes: 'Meme · $0.0000042 down 8% · 200MA declining trend · no catalysts · hold or cut loss · no adds' },
    { id: 'eth', ticker: 'ETH', name: 'Ethereum', platform: 'Binance', type: 'CRY', shares: 1.031663937, price: 1658.07, costPerShare: 3586.88, currency: 'USD', addLevels: [], trimLevels: [{ price: 4000, action: 'break-even exit' }], status: 'WATCH', notes: 'Up 17% to ~$1,943 · $2,050 monthly close is key level · bull case $4,000 · cost $3,587 still 84% away · hold' },
  ...
  config: { dryCash: 5500, addPriority: 'NVDA → AVGO → META → AMD → AMZN → NOW', lastUpdated: null, analysisDate: '2026-07-27T12:00:00.000Z' },
};
