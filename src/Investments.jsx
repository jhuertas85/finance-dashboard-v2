...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', status: 'TRIM', addLevels: [{ price: 420, amount: '$800' }, { price: 375, amount: '$1,000' }], trimLevels: [{ price: 520, action: 'G3 de-risk: trim 2-3 sh into bounce (not into weakness)' }, { price: 620, action: 'sell 4 sh — near consensus' }], notes: 'G3 pending · sell into strength $520+ not weakness · Sep seasonal dip (8/10 yrs) · consensus $554/RJ $641 · wait for bounce', invalidation: 'below $350 = AI semis cycle breaking → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
