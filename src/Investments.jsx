...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', status: 'HOLD', addLevels: [{ price: 420, amount: '$800' }, { price: 375, amount: '$1,000' }], trimLevels: [{ price: 580, action: 'trim 3 sh into parabolic strength — gain-maximizing, not concentration mgmt' }, { price: 640, action: 'trim 4 sh — RJ target zone, near full consensus' }], notes: 'HOLD · let it run · +241% · consensus $614 avg/$1,250 high · trim only at parabolic highs $580+/$640 · Sep dip = opportunity', invalidation: 'below $350 = AI semis cycle breaking → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
    { id: 'nvda', ticker: 'NVDA', name: 'NVIDIA', platform: 'WIO', type: 'STK', shares: 29.79087899, price: 208.65, costPerShare: 181.18, currency: 'USD', status: 'ACCUMULATE', addLevels: [{ price: 200, amount: '$1,500' }, { price: 185, amount: '$1,500' }], trimLevels: [{ price: 295, action: 'trim 6 sh' }, { price: 340, action: 'trim 6 sh' }], notes: 'At $219 · consensus $326 · 48% upside · Blackwell ramp · 60 analysts Strong Buy · adds deepen AI-compute (G5 watch)', invalidation: 'below $170 = AI capex doubts / Blackwell miss → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
    { id: 'avgo', ticker: 'AVGO', name: 'Broadcom', platform: 'WIO', type: 'STK', shares: 5.79772382, price: 392.13, costPerShare: 395.40, currency: 'USD', status: 'ACCUMULATE', addLevels: [{ price: 345, amount: '$1,200' }, { price: 310, amount: '$1,200' }], trimLevels: [{ price: 530, action: 'trim 2 sh' }], notes: 'Earnings blackout: skip pre-print · buy Sept 3 on beat ($370+) or miss ($310-340) · consensus $526 · +42% upside', invalidation: 'below $285 = custom silicon wins drying up → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
  ...
  config: {
    ...
    portfolio: {
      ...
      flags: [
        ...
        'NOW at/above consensus $142 — TRIM 3 sh today; hold 7 for Wells Fargo $175 bull target',
        'AVGO earnings blackout Sept 2 — skip pre-print; buy Sept 3 on reaction ($370+ beat / $310-340 miss)',
