...
const SEED = {
  positions: [
    ...
    { id: 'amd', ticker: 'AMD', name: 'Adv. Micro Devices', platform: 'WIO', type: 'STK', shares: 25.39630338, price: 551.63, costPerShare: 137.91, currency: 'USD', status: 'TRIM', addLevels: [{ price: 420, amount: '$800' }, { price: 375, amount: '$1,000' }], trimLevels: [{ price: 470, action: 'G3 mandatory (+241%): sell 6 sh now' }, { price: 620, action: 'sell 4 sh' }], notes: 'G3 mandatory +241% · sell 6sh ~$470 · consensus $554 · RJ upgraded $641 · AI-compute 48.1% (just under G5)', invalidation: 'below $350 = AI semis cycle breaking → EXIT', theme: 'AI-compute', bucket: 'discretionary' },
